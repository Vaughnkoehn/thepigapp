...
urlpatterns = [
    ...
    url(r'^pen(?P<pigpen>[0-9]+)/delete(?P<model>[a-zA-Z]+)(?P<rationid>[0-9]+)/$', views.delete, name = 'delete'),
    ...
    url(r'^pen(?P<pigpen>[0-9]+)/deadpigs(?P<pigid>[0-9]+)/$', views.dead, name= 'deadpigs'),
    url(r'^pen(?P<pigpen>[0-9]+)/culledpigs(?P<pigid>[0-9]+)/$', views.culled, name= 'culledpigs'),
