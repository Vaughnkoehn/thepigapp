# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-01-12 18:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extras', models.CharField(blank=True, max_length=6, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dynamin', models.CharField(default=0, max_length=3)),
                ('pigpak', models.CharField(default=0, max_length=3)),
                ('sixtyeighty', models.CharField(default=0, max_length=3)),
                ('control', models.CharField(default=0, max_length=3)),
                ('optimax', models.CharField(default=0, max_length=3)),
                ('molderase', models.CharField(default=0, max_length=3)),
                ('hitpork', models.CharField(default=0, max_length=3)),
                ('oats', models.CharField(default=0, max_length=3)),
                ('sowonehundred', models.CharField(default=0, max_length=3)),
                ('porkperformance', models.CharField(default=0, max_length=3)),
                ('spicepak', models.CharField(default=0, max_length=3)),
                ('safeguard', models.CharField(default=0, max_length=3)),
            ],
        ),
        migrations.CreateModel(
            name='Shipped',
